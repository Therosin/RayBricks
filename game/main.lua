...
--- brick colours format is [row]{brickColor, outlineColor}
local brickColours = { { RED, BLACK }, { BLUE, BLACK }, { GREEN, BLACK }, { YELLOW, BLACK }, { ORANGE, BLACK } }
...
--- draw paddle
function drawPaddle(x, len) DrawRectangle(x, screenHeight - paddlePositionY, len, 30, paddleColor) end
